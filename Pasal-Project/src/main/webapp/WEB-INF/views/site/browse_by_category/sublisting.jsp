              ...
              <div id="secondary" class="col-md-4 col-lg-3">
                ...
                <div class="theiaStickySidebar">
                  <aside class="widget">
                    ...
                    <h3 style="color:#9b9898; font-size:14px;"><b>${subcategory.subCategoryName}</b></h3>
                      <ul>
                        <li>
                        <c:forEach var="model" items="${submodel}" varStatus="stat">
	                        	<h3 style="color:#9b9898; padding:4px; font-size:13px;"><a href="/search/${categoryName}/${subcategory.subCategoryName}/${model.subModelName}/id=${model.subModelId}"><b>${model.subModelName}</b></a> (${adCountByModels[stat.index]})</h3>
                        </c:forEach>
                  ...
                  <aside class="widget">
                    ...
                    <div class="cat-lists">
                    		<form method="GET" action="/search/${categoryName}/${subcategory.subCategoryName}/id=${subcategory.subCategoryId}">
	                    		<c:choose>
	                    			<c:when test="${subcategory.subCategoryId eq 1}">
	                    		...
	                    		<c:when test="${subcategory.subCategoryId eq 2}">
               					<div class="form-group">
		                    			<label for="" class="control-label" style="font-size:14px;font-weight: bolder;"><b>Location:</b></label>
		                    			<select name="location" class="form-control">
		                    			  <option value ="">Entire Nepal</option>
                        ...
                        <div id="tab-1" class="tab-pane fade in show active"  role="tabpanel">
                          <div class="row">
                            ...
                            <table class="table table-hover">
                            		...
                            		<c:forEach var="list" items="${sublisting}">
                            		<!-- Testing Date -->
									  	<p>
