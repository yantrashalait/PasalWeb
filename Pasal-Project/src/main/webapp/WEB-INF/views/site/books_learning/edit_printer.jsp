  ...
  <%@include file="../includes/navUtils.jsp"%>
                    <div class="expandablebox">
                      ...
                      <form:form class="secondaryform" action="/member/editAds/books/save" method="POST" modelAttribute="mainAds">
	                        ...
	                        <!-- Start of Printer Specification Table -->
	                        ...
	                        <div class="form-group">
	                          ...
	                          <div class="right">
	                            <form:select class="halfwidth" type="text" id="type" path="type" placeholder="Select Type" required="required">
	                              <option>${printerSpec.type}</option>
	                              <option>Laser Printer</option>
	                              <option>Inkjet Printer</option>
	                              <option>Dot Matrix / Thermal Printer</option>
	                              <option>Scanner Only</option>
	                        ...
	                        <div class="form-group">
			                          ...
			                          <div class="right">
			                            <div class="checkboxlist" required="required">
			                                ...
			                                <form:checkbox id="features" path="features" value="Color Print"/> Color Print
			                              	</br>
			                              	<form:checkbox id="features" path="features" value="Fax"/> Fax
			                              	</br>
			                              	<form:checkbox id="features" path="features" value="Scan"/> Scan
			                              	</br>
			                              	<form:checkbox id="features" path="features" value="Photocopy"/> Photocopy
			                              	</br>
			                              	<form:checkbox id="features" path="features" value="Wireless WiFi"/> Wireless WiFi
			                              	</br>
			                              	<form:checkbox id="features" path="features" value="Ethernet LAN"/> Ethernet LAN
			                              	</br>
			                              	<form:checkbox id="features" path="features" value="Auto Duplex"/> Auto Duplex
			                              	</br>
	                        ...
	                        <!-- End of Printers Specification Table -->
                        ...
                        <p style="color:blue;">(You can edit your picture in next step.)</p>
                        	...
                        	</form:form> <!-- Ntworking Form Close -->
