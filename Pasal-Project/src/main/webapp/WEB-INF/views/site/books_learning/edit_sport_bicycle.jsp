  ...
  <%@include file="../includes/navUtils.jsp"%>
                    <div class="expandablebox">
                      ...
                      <form:form class="secondaryform" action="/member/editAds/books/save" method="POST" modelAttribute="mainAds">
	                        ...
	                        <!-- Start of Sport Bicycle Specification Table -->
	                        	<form:form class="secondaryform" action="/member/editAds/books/save" method="POST" modelAttribute="sportBicycleSpec">
	                        <form:input type="hidden" path="id" id="id" value="${sportBicycleSpec.id}"/>
	                        ...
	                        <div class="form-group">
	                          ...
	                          <div class="right">
	                            <form:select class="halfwidth" type="text" id="type" path="type" placeholder="Select Type" required="required">
	                              <option>${sportBicycleSpec.type}</option>
	                              <option>City Road</option>
	                              <option>Mountain</option>
	                              <option>BMX / Fat</option>
	                              <option>Kids</option>
	                        ...
	                        <div class="form-group">
	                          <label class="label">Body <font class="red">*</font></label>
	                          <div class="right">
	                            <form:select class="halfwidth" type="text" id="body" path="body" placeholder="Select Body" required="required">
	                              <option>${sportBicycleSpec.body}</option>
	                              <option>Steel</option>
	                        ...
	                        <div class="form-group">
	                          <label class="label">Wheel Size <font class="red">*</font></label>
	                          <div class="right">
	                            <form:select class="halfwidth" type="text" id="wheelSize" path="wheelSize" placeholder="Select Wheel Size" required="required">
	                              <option>${sportBicycleSpec.wheelSize}</option>
	                              <option>12 inch</option>
	                              <option>16 inch</option>
	                              <option>20 inch</option>
	                              <option>24 inch</option>
	                              <option>26 inch</option>
	                              <option>27.5 inch</option>
	                              <option>29 inch</option>
	                            </form:select>
	                          </div>
	                        </div>
	                        
	                        <div class="form-group">
	                          <label class="label">Gears <font class="red">*</font></label>
	                          <div class="right">
	                            <form:select class="halfwidth" type="text" id="gear" path="gear" placeholder="Select Gear" required="required">
	                              <option>${sportBicycleSpec.gear}</option>
	                        ...
	                        <!-- End of Sport Bicycle Specification Table -->
                        ...
                        <p style="color:blue;">(You can edit your picture in next step.)</p>
                        	...
                        	</form:form> <!-- Sport BiCycle Form Close -->
