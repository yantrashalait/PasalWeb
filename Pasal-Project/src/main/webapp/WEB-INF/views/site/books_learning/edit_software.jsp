  ...
  <%@include file="../includes/navUtils.jsp"%>
                    <div class="expandablebox">
                      ...
                      <form:form class="secondaryform" action="/member/editAds/books/save" method="POST" modelAttribute="mainAds">
	                        ...
	                        <!-- Start of Software Specification Table -->
	                        	<form:form class="secondaryform" action="/member/editAds/books/save" method="POST" modelAttribute="softwareSpec">
	                        <form:input type="hidden" path="id" id="id" value = "${softwareSpec.id}"/>
	                        
	                        <div class="form-group">
	                          <label class="label">Genre <font class="red">*</font></label>
	                          <div class="right">
	                            <form:select class="halfwidth" type="text" id="genre" path="genre" placeholder="Select Genre" required="required">
	                              <option>${softwareSpec.genre}</option>
	                        ...
	                        <!-- End of Software Specification Table -->
