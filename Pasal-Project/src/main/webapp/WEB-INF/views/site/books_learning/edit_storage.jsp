  ...
  <%@include file="../includes/navUtils.jsp"%>
                    <div class="expandablebox">
                      ...
                      <form:form class="secondaryform" action="/member/editAds/books/save" method="POST" modelAttribute="mainAds">
	                       ...
	                       <!-- Start of Storage Specification Table -->
	                        	<form:form class="secondaryform" action="/member/editAds/books/save" method="POST" modelAttribute="storageSpec">
	                        <form:input type="hidden" path="id" id="id" value="${storageSpec.id}"/>
	                        
	                        <div class="form-group">
	                          <label class="label">Storage Type <font class="red">*</font></label>
	                          <div class="right">
	                            <form:select class="halfwidth" type="text" id="storageType" path="storageType" placeholder="Select Storage Type" required="required">
	                              <option>${storageSpec.storageType}</option>
	                              <option>USB Pen Drive</option>
	                              <option>Hard Disk - External</option>
	                              <option>Hard Disk - Desktop</option>
	                              <option>Hard Disk - Laptop</option>
	                              <option>CD, DVD, Blueray - Internal</option>
	                              <option>CD, DVD, Blueray - External</option>
	                              <option>Solid State Disk (SSD)</option>
	                        ...
	                        <div class="form-group">
	                          <label class="label">Size (GB/TB)</label>
	                          <div class="right">
	                            <div class="checkboxlist">
	                              <span>
	                                <form:input class="halfwidth" type="text" id="size" path="size" placeholder="Example: 3 Tb"/>
	                              </span>
	                            </div>
	                          </div>
	                        </div>
	                       ...
	                       <form:input type="hidden" path="mainAds" id="mainAds"/>
	                        ...
	                        <!-- End of Storage Specification Table -->
