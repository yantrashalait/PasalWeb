                    ...
                    <div class="expandablebox">
                      ...
                      <form:form class="secondaryform" action="/member/editAds/books/save" method="POST" modelAttribute="mainAds">
	                        ...
	                        <!-- Start of Networking Specification Table -->
	                        	<form:form class="secondaryform" action="/member/editAds/books/save" method="POST" modelAttribute="networkingSpec">
	                        <form:input type="hidden" path="id" id="id" value="${networkingSpec.id}"/>
	                        ...
	                        <div class="form-group">
	                          ...
	                          <div class="right">
	                            <form:select class="halfwidth" type="text" id="type" path="type" placeholder="Select Type" required="required">
	                              <option>${networkingSpec.type}</option>
                        ...
                        <p style="color:blue;">(You can edit your picture in next step.)</p>
                        	...
                        	</form:form> <!-- Networking Form Close -->
